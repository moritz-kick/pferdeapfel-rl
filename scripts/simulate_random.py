...
def simulate_game(log: bool = False, verbose: bool = True) -> dict[str, Any]:
    """
...
def simulate_multiple(n_games: int = 10, log: bool = False, verbose: bool = True) -> dict[str, Any]:
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("-n", "--num-games", type=int, default=1, help="Number of games to simulate")
    parser.add_argument("--log", action="store_true", help="Log games to data/logs/game/")
