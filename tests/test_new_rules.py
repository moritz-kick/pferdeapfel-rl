...
class TestNewRules(unittest.TestCase):
    ...
    def test_turn_sequence_brown_phase(self):
    ...
    def test_golden_phase_transition(self):
    ...
    def test_white_wins_on_golden_phase_start(self):
    ...
    def test_white_wins_on_golden_exhaustion(self):
